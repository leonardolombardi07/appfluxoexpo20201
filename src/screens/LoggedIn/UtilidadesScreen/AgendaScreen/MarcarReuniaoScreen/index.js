            ...
            <View style={styles.formsContainer}>
                ...
                <View style={styles.formsRowContainer}>
                    ...
                    <View style={styles.dateTimePickerButtonContainer}>
                        ...
                        <Text style={styles.datePickerTextStyle}>{formsData.day.toLocaleDateString()}</Text>
                    ...
                    <View style={styles.dateTimePickerButtonContainer}>
                        ...
                        <Text style={styles.datePickerTextStyle}>{formsData.horaInicio.toLocaleTimeString().substr(0,5)}</Text>
                        <MaterialIcons name='keyboard-arrow-down' size={25} color="grey" />
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.dateTimePickerButtonContainer}>
                        ...
                        <Text style={styles.datePickerTextStyle}>{formsData.horaFinal.toLocaleTimeString().substr(0,5)}</Text>
                        <MaterialIcons name='keyboard-arrow-down' size={25} color="grey" />
                        </TouchableOpacity>
                    </View>
                </View>
                {/* Erro */}
                { formsData.horaFinal.toLocaleTimeString().substr(0,5) < formsData.horaInicio.toLocaleTimeString().substr(0,5) ?
                <Text style={styles.validationErrorText}>Uops... Reunião terminando antes de começar? </Text> : null}
                {/* Terceira linha */}
                <View style={styles.formsRowContainer}>
